...
public class Books3coe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books3coe);

        b1 = (CuboidButton) findViewById(R.id.books3coe1);
        ...
        b2 = (CuboidButton) findViewById(R.id.books3coe2);
        b2.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/stimulation%20modelling%20and%20analysis.pdf?alt=media&token=bce96960-8d8b-4ce8-94ee-9dca4be38245");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b3 = (CuboidButton) findViewById(R.id.books3coe3);
        b3.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/Rosen_Discrete_Mathematics_and_Its_Applications_7th_Edition.pdf?alt=media&token=1de94eb3-4a97-4a4a-9bc0-7219f2f22738");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b4 = (CuboidButton) findViewById(R.id.books3coe4);
        ...
        b5 = (CuboidButton) findViewById(R.id.books3coe5);
        ...
        b6 = (CuboidButton) findViewById(R.id.books3coe6);
        ...
        b7 = (CuboidButton) findViewById(R.id.books3coe7);
