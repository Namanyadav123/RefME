...
public class Books4se extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books4se);

        b1 = (CuboidButton) findViewById(R.id.books4se1);
        b1.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                Toast.makeText(Books4se.this,"Sorry,Not Available",Toast.LENGTH_SHORT).show();

            }


        });
        b2 = (CuboidButton) findViewById(R.id.books4se2);
        ...
        b3 = (CuboidButton) findViewById(R.id.books4se3);
        ...
        b4 = (CuboidButton) findViewById(R.id.books4se4);
        ...
        b5 = (CuboidButton) findViewById(R.id.books4se5);
        b5.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/SOFTWARE%20ENGINEERING.pdf?alt=media&token=df0bdb94-30e0-4da3-8470-8bef41a34ad3");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b6 = (CuboidButton) findViewById(R.id.books4se6);
