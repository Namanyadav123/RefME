    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(EP.this,Books3ep.class);
                startActivity(i);
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(EP.this,"Sorry,Papers Are Not Available Now For This Sem,They'll Be Uploaded Soon",Toast.LENGTH_SHORT).show();
        ...
        t4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(EP.this,Cont1.class);
                startActivity(i);
