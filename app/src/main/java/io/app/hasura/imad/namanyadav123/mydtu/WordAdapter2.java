    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.activity_third, parent, false);
        }
        ...
        TextView miwokTextView = (TextView) listItemView.findViewById(R.id.miwok_text_view2);
        ...
        ImageView imageView = (ImageView) listItemView.findViewById(R.id.image65);
