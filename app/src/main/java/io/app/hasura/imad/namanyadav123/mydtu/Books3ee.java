...
public class Books3ee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books3ee);

        b1 = (CuboidButton) findViewById(R.id.books3ee1);
        ...
        b2 = (CuboidButton) findViewById(R.id.books3ee2);
        ...
        b3 = (CuboidButton) findViewById(R.id.books3ee3);
        ...
        b4 = (CuboidButton) findViewById(R.id.books3ee4);
        ...
        b5 = (CuboidButton) findViewById(R.id.books3ee5);
        ...
        b6 = (CuboidButton) findViewById(R.id.books3ee6);
        ...
        b7 = (CuboidButton) findViewById(R.id.books3ee7);
