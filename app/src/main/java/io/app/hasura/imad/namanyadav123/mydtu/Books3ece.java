...
public class Books3ece extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books3ece);

        b1 = (CuboidButton) findViewById(R.id.books3ece1);
        ...
        b2 = (CuboidButton) findViewById(R.id.books3ece2);
        ...
        b3 = (CuboidButton) findViewById(R.id.books3ece3);
        b3.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/introduction-to-instrumentation-and-measurements-2-edition-by-robert-b-northrop.pdf?alt=media&token=6d50edcf-a4ce-4e0b-93fc-a55a2a007cdc");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b4 = (CuboidButton) findViewById(R.id.books3ece4);
        ...
        b5 = (CuboidButton) findViewById(R.id.books3ece5);
        b5.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/b.signals%20and%20systems%2C%202ed%20-%20A.V.Oppenheim%20%26%20A.S.Willsky%20(Prentice%20Hall)%20(1).pdf.pdf?alt=media&token=65ca67de-498c-498c-9f17-d94e05984ff9");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b6 = (CuboidButton) findViewById(R.id.books3ece6);
        ...
        b7 = (CuboidButton) findViewById(R.id.books3ece7);
