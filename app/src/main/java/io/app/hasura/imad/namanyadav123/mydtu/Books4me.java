...
public class Books4me extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books4me);

        b1 = (CuboidButton) findViewById(R.id.books4me1);
        ...
        b2 = (CuboidButton) findViewById(R.id.books4me2);
        ...
        b3 = (CuboidButton) findViewById(R.id.books4me3);
        ...
        b4 = (CuboidButton) findViewById(R.id.books4me4);
        ...
        b5 = (CuboidButton) findViewById(R.id.books4me5);
        b5.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                dm = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/fir-dtu.appspot.com/o/thermodynamics_by-onkar_singh%20-%20Copy.pdf?alt=media&token=d6fa3df8-7cd5-4002-a614-1e19539c8dd9");
                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
        ...
        b6 = (CuboidButton) findViewById(R.id.books4me6);
